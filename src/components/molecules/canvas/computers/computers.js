...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={[invert ? 'black' : '#84CC16']} />
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <Text font="/fonts/outfit-semibold.ttf" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#84CC16'}>
        0000.codes
      </Text>
    </Screen>
  )
