  ...
  return (
    <section className='flex items-center justify-center place-content-center p-0 h-full w-full'>
      <span className='fixed z-30'>
        <FadeIn>
          <p className='font-light text-secondary dark:text-gray-200'>{t('greeting')}</p>
          <AnimatedName />
      ...
      {/*
        ...
        <div className='md:space-y-10 space-y-8 relative z-10'>
          <header>
            ...
            <h2 className='text-muted-foreground md:text-2xl sm:text-xl text-base align-middle items-center'>
              {/* <span className='animate-pulse'>&gt;_ </span> 
              <Badge className='bg-gradient-to-r from-blue-500 to-gray-400 dark:bg-gradient-to-r dark:from-blue-700 dark:to-gray-600 text-secondary dark:text-gray-200 mr-3'>
                {t('job')}
              </Badge>
              <Badge className='bg-gradient-to-r from-orange-500 to-violet-500 dark:bg-gradient-to-r dark:from-orange-700 dark:to-violet-700 text-secondary dark:text-gray-200'>
                Sound Designer
              </Badge>
            </h2>
