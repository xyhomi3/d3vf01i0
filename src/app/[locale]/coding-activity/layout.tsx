...
const description =
  'Dive into my coding activity page to discover insights into my work hours, coding time, and the current programming languages in focus this week. Get a transparent glimpse into my coding routine, offering a quick snapshot of the tools and dedication that drive my passion for development.'
